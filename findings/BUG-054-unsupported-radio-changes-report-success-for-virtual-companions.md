...
**Current status: 🟡 Partially fixed.** Virtual companions are now explicitly capability-gated: they read radio state from the shared host, do not mutate stored radio preferences, and backend-owned companions report BAD_STATE when an attempted hardware change fails. However, a valid unsupported radio or TX-power write to a virtual companion is still deliberately acknowledged with OK as a no-op so a multi-setting app transaction can continue. That removes the preference/hardware divergence but still reports success for an unapplied change, contrary to this finding's required rejection semantics; see [the no-op success branches](https://github.com/openhop-dev/openhop_core/blob/9355d08e21423886a17979c0d8defb891f5d9d72/src/openhop_core/companion/frame_server/commands_device.py#L316-L364) and [CompanionBridge's non-mutating capability implementation](https://github.com/openhop-dev/openhop_core/blob/9355d08e21423886a17979c0d8defb891f5d9d72/src/openhop_core/companion/companion_bridge.py#L373-L387). The partial fix is present at Core functional commit [`9355d08`](https://github.com/openhop-dev/openhop_core/commit/9355d08e21423886a17979c0d8defb891f5d9d72) and wired by Repeater merge commit [`6aafa7f`](https://github.com/openhop-dev/openhop_repeater/commit/6aafa7fe991b5b3199b18149f84417f8522d94b2). Rechecked against current Core head [`9ea7269`](https://github.com/openhop-dev/openhop_core/commit/9ea7269a7e7e903fe433b1f952a4026fe3dcc81b), which is a version-only bump after [`9355d08`](https://github.com/openhop-dev/openhop_core/commit/9355d08e21423886a17979c0d8defb891f5d9d72), and current Repeater head [`9688fe7`](https://github.com/openhop-dev/openhop_repeater/commit/9688fe70e44d85f3cec7de5c77dd804d915a7506), whose only later change after [`6aafa7f`](https://github.com/openhop-dev/openhop_repeater/commit/6aafa7fe991b5b3199b18149f84417f8522d94b2) adds observation-only neighbour-link metrics; no regression was found.
...
- **OpenHop Repeater:** `repeater/companion/bridge.py`
- **OpenHop Repeater:** `repeater/main.py`

[Open the suggested patch](../patches/BUG-054.patch)
