...
BUG-023 was previously separated as an intentional routing-policy divergence. Core [`abe1d85`](https://github.com/openhop-dev/openhop_core/commit/abe1d857734d5d1f549ada27af6f95c7e5e53e95) and Repeater [`b62960f`](https://github.com/openhop-dev/openhop_repeater/commit/b62960fa3041447bedadb2131d892a6565d7e519) now implement MeshCore’s disabled-by-default reception-quality flood hold, so it has been moved into the ordinary fixed archive.
